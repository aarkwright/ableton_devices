...
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\model\declaration.py
...
class ModelVisitor(object):
    ...
    def visit_class_declarations(self, class_):
        view_properties = ((
         isinstance(decl, property_declaration) and name, decl) for name, decl in class_.__dict__.iteritems())
