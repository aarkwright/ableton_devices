...
class WavetableDeviceComponent(DeviceComponentWithTrackColorViewData):
    ...
    VISUALISATION_CONFIGURATION = {b'wavetable': {b'position_in_banks': {0: ButtonRange(0, 2), 
                                             1: ButtonRange(1, 3)}, 
                      b'visible_in_bank': lambda component, bank: component.selected_oscillator in [
                                         WavetableOscillatorType.one,
                                         WavetableOscillatorType.two]}, 
       b'filter': {b'position_in_banks': {0: ButtonRange(3, 5), 
                                          2: ButtonRange(2, 4)}}, 
       b'lfo': {b'position_in_banks': {5: ButtonRange(0, 3)}}, 
       b'envelope': {b'position_in_banks': {4: ButtonRange(2, 5)}}}
    ENVELOPE_PREFIXES = [
