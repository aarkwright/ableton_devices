...
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\_Generic\Devices.py
...
DEVICE_DICT = {b'AudioEffectGroupDevice': RCK_BANKS, 
   ...
   b'Resonator': RSN_BANKS, b'StereoGain': UTL_BANKS, 
   b'Tube': DTB_BANKS, b'Reverb': RVB_BANKS, b'Vinyl': VDS_BANKS, b'Gate': GTE_BANKS, 
   b'Vocoder': VOC_BANKS, b'Amp': AMP_BANKS, b'Cabinet': CAB_BANKS, 
...
DEVICE_BOB_DICT = {b'AudioEffectGroupDevice': RCK_BOBS, 
   ...
   b'Resonator': RSN_BOBS, b'StereoGain': UTL_BOBS, 
   b'Tube': DTB_BOBS, b'Reverb': RVB_BOBS, b'Vinyl': VDS_BOBS, b'Gate': GTE_BOBS, 
   b'Vocoder': VOC_BOBS, b'Amp': AMP_BOBS, b'Cabinet': CAB_BOBS, 
...
BANK_NAME_DICT = {b'AudioEffectGroupDevice': RCK_BNK_NAMES, 
   ...
   b'AutoFilter': AFL_BNK_NAMES, b'StereoGain': UTL_BNK_NAMES, b'DrumBuss': DRB_BANK_NAMES, 
