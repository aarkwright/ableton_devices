...
class Elements(object):
    ...
    def __init__(self, deleter=None, undo_handler=None, pad_sensitivity_update=None, playhead=None, velocity_levels=None, continuous_mapping_sensitivity=None, fine_grained_continuous_mapping_sensitivity=None, full_velocity=None, *a, **k):
        ...
        self.select_buttons = ButtonMatrixElement(name=b'Track_Select_Buttons', rows=[
        ...
        self.track_state_buttons = ButtonMatrixElement(name=b'Track_State_Buttons', rows=[
        ...
        self.side_buttons = ButtonMatrixElement(name=b'Scene_Launch_Buttons', rows=[
        ...
        self.global_param_touch_buttons = ButtonMatrixElement(name=b'Track_Control_Touches', rows=[
         self.global_param_touch_buttons_raw])
        self.parameter_controls_raw = [ TouchEncoderElement(channel=0, identifier=71 + index, map_mode=consts.GLOBAL_MAP_MODE, undo_step_handler=undo_handler, delete_handler=deleter, encoder_sensitivity=BASE_ENCODER_SENSITIVITY, name=b'Track_Control_' + str(index), touch_element=self.global_param_touch_buttons_raw[index]) for index in xrange(8)
                                      ]
        self.global_param_controls = ButtonMatrixElement(name=b'Track_Controls', rows=[
